  ...
  return (
    <div className="navbar">
      <nav className="navbar__nav">
        ...
        <ul>
          <li calssName="navbar__nav-list">Cocktails</li>
          <li calssName="navbar__nav-list">Favorites</li>
          <li calssName="navbar__nav-list">My Cocktails</li>
          <li calssName="navbar__nav-list">Login</li>
        </ul>
      </nav>
    </div>
  );
